...
public class TransactionService {
    ...
    public TransactionResponse crearTransaccion(String pan, String referencia, BigDecimal totalCompra, String direccionCompra) {
    ...
    public TransactionResponse anularTransaccion(String pan, String referencia, BigDecimal totalCompra) {
        TransactionResponse response = new TransactionResponse();
        Optional<Transaction> transactionOptional = transactionRepository.findByTarjetaPanAndReferencia(pan, referencia);
