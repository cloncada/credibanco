...
import com.credibanco.assessment.card.exception.TarjetaException;
import com.credibanco.assessment.card.model.Tarjeta;
import com.credibanco.assessment.card.response.EnrolarResponse;
import com.credibanco.assessment.card.response.TarjetaResponse;
...
public class TarjetaController {
    ...
    @PostMapping("/enrolar")
    public ResponseEntity<EnrolarResponse> enrolarTarjeta(@RequestParam String pan, @RequestParam int numeroValidacion) throws TarjetaException {
    ...
    @DeleteMapping("/{pan}")
    public ResponseEntity<Void> eliminarTarjeta(@PathVariable String pan, @RequestParam int numeroValidacion) throws TarjetaException {
