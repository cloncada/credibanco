...
import com.credibanco.assessment.card.response.TransactionResponse;
...
public class TransactionController {
    ...
    public ResponseEntity<TransactionResponse> crearTransaccion(@RequestBody TransactionDTO request) {
        TransactionResponse response = transactionService.crearTransaccion(request.getPan(), request.getReferencia(), request.getTotalCompra(), request.getDireccionCompra());
    ...
    public ResponseEntity<TransactionResponse> anularTransaccion(@RequestBody TransactionDTO request) {
        TransactionResponse response = transactionService.anularTransaccion(request.getPan(), request.getReferencia(), request.getTotalCompra());
        return ResponseEntity.ok(response);
    }
